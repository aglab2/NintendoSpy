...
namespace NintendoSpy
{
    public class InputSource
    {
        ...
        static public readonly InputSource N64 = new InputSource ("n64", "Nintendo 64", true, false, controllerId => new EmulatorReader (controllerId));
        ...
        static public readonly IReadOnlyList <InputSource> ALL = new List <InputSource> {
            //NES, SNES, N64, GAMECUBE, CLASSICCONTROLLER, 
            N64, PC360, PAD
        };
        static public readonly HashSet<string> AllowedNames = new HashSet<string> { "n64", "pc360", "generic" };

        static public readonly InputSource DEFAULT = N64;
